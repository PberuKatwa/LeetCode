...
list_a = LinkedList()
list_a.create_list_array([9,9,9,9,9,9,9])

list_b = LinkedList()
list_b.create_list_array([9,9,9,9])

def add_reverse_linked_list(list_a:LinkedList, list_b:LinkedList):
    total = 0

    num_a = list_a.reverse_list_to_int()
    num_b = list_b.reverse_list_to_int()
...
print("TOTALLLL", add_reverse_linked_list(list_a,list_b))