...
head_2 = create_linked_list([1,3,4])
...
def merge_two_sorted_list(list_1:LinkedList,list_2:LinkedList):
    ...
    while list_1 and list_2 is not None:
        if list_1.data > list_2.data:
            ...
            print("listtt_1_more", list_1.data, "222", list_2.data)


            current.next = LinkedList(list_2.data)
            current = current.next
            list_2 = list_2.next
        else:
            print("listtt_1_less ", list_1.data, "2222", list_2.data)

            current.next = LinkedList(list_1.data)
            current = current.next
            list_1 = list_1.next
